...
const Checkout = () => {
  ...
  return (
    <>
      {orderId ? (
        <CompraConfirm orderId={orderId} order={order} />
      ) : (
        <div className="container checkout-page mt-5">

          <Link to="/" className="back-link d-flex align-items-center gap-2 text-decoration-none">
            <FaArrowLeft /> Volver
          </Link>
          ...
          <div className="card shadow-sm p-4">
            ...
            <form onSubmit={handleSubmit(finalizarCompra)}>
              ...
              <div className="mb-3">
                ...
                <input className="form-control" {...register("validMail")} />
                <p className="text-danger">{errors.validMail?.message}</p>
              </div>
